...
@property (nonatomic) IBInspectable BOOL valuesAbove; // struehow knob values above knobs - must have showValues=YES
@property (nonatomic) IBInspectable BOOL showGreaterThanMaxVal; // adds a + to the end of maxVal to indicate greater
